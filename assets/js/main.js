...
const sendEmail = e => {
    ...
    if (contactName.value === '' || contactEmail.value === '' || contactProject.value === '') {
        ...
        emailjs.sendForm('service_l0ilo3j', 'template_sjmmp2d', '#contact-form', '3i1NAsymlRM_yteJG').then(() => {
...
const scrollHeader = () => {
    ...
    //When the scroll is greater than 50 viewport height, add the scroll-header clas to the geader tag
